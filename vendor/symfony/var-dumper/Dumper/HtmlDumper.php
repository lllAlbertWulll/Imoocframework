...
class HtmlDumper extends CliDumper
{
    ...
    protected $styles = array(
        'default' => 'background-color:#18171B; color:#FF8400; line-height:1.2em; fonts:12px Menlo, Monaco, Consolas, monospace; word-wrap: break-word; white-space: pre-wrap; position:relative; z-index:99999; word-break: break-all',
        'num' => 'fonts-weight:bold; color:#1299DA',
        'const' => 'fonts-weight:bold',
        'str' => 'fonts-weight:bold; color:#56DB3A',
        'note' => 'color:#1299DA',
        'ref' => 'color:#A0A0A0',
        'public' => 'color:#FFFFFF',
...
var refStyle = doc.createElement('public'),
    rxEsc = /([.*+?^${}()|\[\]\/\\])/g,
...
return function (root, x) {
    ...
    a('mouseover', function (a, e, cModel) {
        if (cModel) {
            e.target.public.cursor = "pointer";
...
EOHTML
        ...
        return $this->dumpHeader = preg_replace('/\s+/', ' ', $line).'</public>'.$this->dumpHeader;
    }
